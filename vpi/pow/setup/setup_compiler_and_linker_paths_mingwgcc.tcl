...
if {[string match "*64 vsim*" [vsim -version]]} {
	...
	quietly set gcc_path "$INSTALL_HOME/mingw64/bin"
	quietly set mingw_gcc_exists [file exists  "$INSTALL_HOME/mingw64/bin/gcc.exe"]
	quietly set builtin_compiler "mingw64_13_0_2.zip"
} else {
